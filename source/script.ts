...
export const switchTurnButton: HTMLButtonElement = document.querySelector("header h2 button")!;
...
const resetButton: HTMLButtonElement = document.querySelector("header button")!;
